...
/** ######################################################################
Driver for the BME280-Sensor (under development!)
Source froked from https://github.com/orgua/iLib
...
class BME280 : public i2cSensor, public manualSensor
{
...
// CALIBRATION DATA, 25 Register. 0x88 - 0xA1
    ...
    static const uint8_t		VAL_ID					=(0x60); // BMP280: =(0x58);
    ...
    static const uint8_t 		VAL_SB_0010			    =(B11000000); // BMP280: VAL_SB_2000
    static const uint8_t 		VAL_SB_0020			    =(B11100000); // BMP280: VAL_SB_4000
